...
sellerRouter.route('/:userId/catalogue/search').get(minimalRateLimiter, sellerController.searchProducts); // pagination; optional queries PENDING, APPROVED, REJECTED
