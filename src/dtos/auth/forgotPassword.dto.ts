...
async function validateForgotPasswordDto(req: Request): Promise<void> {
  const dtoInstance = plainToInstance(ForgotPasswordDto, req.body);
...
export default validateForgotPasswordDto;
