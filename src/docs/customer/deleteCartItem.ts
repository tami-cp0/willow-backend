 ...
 *   delete:
 *     summary: Remove an item from the customer's cart
 *     description: >
 *       Deletes a specific cart item identified by productId from the customer's cart.
 ...
 *         schema:
 *           type: string
 *         description: The product ID of the item to remove from the cart.
 *     responses:
 *       200:
